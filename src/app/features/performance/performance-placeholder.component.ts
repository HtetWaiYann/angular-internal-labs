...
@Component({
  ...
  template: `
    <div class="coming-soon">
      ...
      <h2 class="cs-title">Performance Profiler</h2>
      <p class="cs-desc">
        Change detection/sec · render time · memory estimate ·
        active subscriptions · signal recompute frequency · bottleneck detection
      </p>
