...
@Component({
  selector: 'app-replay-placeholder',
  template: `
    <div class="coming-soon">
      <span class="cs-icon">⏮</span>
      <h2 class="cs-title">Execution Replay Engine</h2>
      <p class="cs-desc">
        Records sessions and allows replay with play/pause,
        timeline scrubber, and step-by-step navigation
      </p>
...
export class ReplayPlaceholderComponent {}
